...
export default function ContactPage() {
  ...
  useEffect(() => {
    const handleKeyDown = (e: KeyboardEvent) => {
      if ((e.metaKey || e.ctrlKey) && e.key === "Enter") {
        if (formRef.current && status === "idle") {
          e.preventDefault();
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const key = process.env.NEXT_PUBLIC_WEB3FORMS_KEY || "YOUR_ACCESS_KEY_HERE";
        ...
        <div className="max-w-[560px] w-full flex flex-col gap-12">
          ...
          <div className="flex flex-col gap-4">
            <motion.h1 
              ...
              className="text-white text-[32px] md:text-[44px] font-marketing font-light tracking-tight"
            >
            ...
            >
              Tell me about your product vision, engineering challenges, or architectural needs.
            </motion.p>
          </div>
