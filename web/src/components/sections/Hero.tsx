    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <a href="#featured-stories" className="inline-flex items-center justify-center px-8 py-4 bg-text-light text-white rounded-full font-ui text-sm font-medium hover:bg-black transition-colors duration-200">
            Explore My Work
          </a>
        </motion.div>
      </motion.div>
